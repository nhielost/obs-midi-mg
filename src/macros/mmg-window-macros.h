...
#define INSERT_SUB_OPTIONS()                                                                       \
  ...
  case MMGAction::Category::MMGACTION_STREAM:                                                      \
    set_sub_options({"Start Streaming", "Stop Streaming", "Toggle Streaming"});                    \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_RECORD:                                                      \
    set_sub_options({"Start Recording", "Stop Recording", "Toggle Recording", "Pause Recording",   \
		     "Resume Recording", "Toggle Pause Recording"});                               \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_VIRCAM:                                                      \
    set_sub_options({"Start Virtual Camera", "Stop Virtual Camera", "Toggle Virtual Camera"});     \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_REPBUF:                                                      \
    set_sub_options({"Start Replay Buffer", "Stop Replay Buffer", "Toggle Replay Buffer",          \
		     "Save Replay Buffer"});                                                       \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_STUDIOMODE:                                                  \
    set_sub_options({"Turn On Studio Mode", "Turn Off Studio Mode", "Toggle Studio Mode",          \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_VIDEO:                                                \
    set_sub_options({"Move Source", "Display Source", "Source Locking", "Source Crop",             \
		     "Align Source", "Source Scale", "Source Scale Filtering", "Rotate Source",    \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_AUDIO:                                                \
    set_sub_options({"Change Source Volume To", "Change Source Volume By", "Mute Source",          \
		     "Unmute Source", "Toggle Source Mute", "Source Audio Offset",                 \
		     "Source Audio Monitor"});                                                     \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_SOURCE_MEDIA:                                                \
    set_sub_options({"Play or Pause", "Restart", "Stop", "Set Track Time", "Next Track",           \
		     "Previous Track", "Skip Forward Time", "Skip Backward Time"});                \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_TRANSITION:                                                  \
    set_sub_options({"Change Current Transition", /*"Set Transition Bar Position (Studio Mode)",*/ \
		     "Set Source Show Transition", "Set Source Hide Transition"});                 \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_FILTER:                                                      \
    set_sub_options(                                                                               \
      {"Show Filter", "Hide Filter", "Toggle Filter Display", "Reorder Filter Appearance"});       \
    break;                                                                                         \
  ...
  case MMGAction::Category::MMGACTION_INTERNAL:                                                    \
    set_sub_options({"Do 1 Action", "Do 2 Actions", "Do 3 Actions"});                              \
    break;                                                                                         \
...
#define INSERT_FIRST_OPTION()                                                                    \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_AUDIO:                                              \
    ...
    MMGAction::do_obs_source_enum(ui->editor_str1, MMGAction::Category::MMGACTION_SOURCE_AUDIO); \
    break;                                                                                       \
  case MMGAction::Category::MMGACTION_SOURCE_MEDIA:                                              \
    set_strs_visible(true);                                                                      \
    ui->label_str1->setText("Source");                                                           \
  ...
  case MMGAction::Category::MMGACTION_FILTER:                                                    \
    set_strs_visible(true);                                                                      \
    ui->label_str1->setText("Source");                                                           \
    MMGAction::do_obs_source_enum(ui->editor_str1, MMGAction::Category::MMGACTION_FILTER);       \
    break;                                                                                       \
  case MMGAction::Category::MMGACTION_HOTKEY:                                                    \
    set_strs_visible(true);                                                                      \
  ...
  case MMGAction::Category::MMGACTION_INTERNAL:                                                  \
    ...
    MMGAction::do_mmg_binding_enum(ui->editor_str1, current_binding->get_name(),                 \
...
#define INSERT_SECOND_OPTION()                                                                     \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_VIDEO:                                                \
    ...
    MMGAction::do_obs_source_enum(ui->editor_str2, MMGAction::Category::MMGACTION_SCENE, value);   \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_SOURCE_AUDIO:                                                \
    ...
    case MMGAction::AudioSources::SOURCE_AUDIO_MONITOR:                                            \
      ...
      ui->editor_str2->addItems({"Off", "Monitor Only", "Monitor & Output", "Use Message Value"}); \
      break;                                                                                       \
    default:                                                                                       \
      break;                                                                                       \
    }                                                                                              \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_MEDIA:                                                \
    ...
    case MMGAction::MediaSources::SOURCE_MEDIA_TIME:                                               \
      set_doubles_visible(true);                                                                   \
      ui->label_double1->setText("Time");                                                          \
      lcd_double1.set_range(0.0, get_obs_media_length(current_action->get_str(0)));                \
      lcd_double1.set_step(1.0, 10.0);                                                             \
      lcd_double1.set_default_value(0.0);                                                          \
      break;                                                                                       \
  ...
  case MMGAction::Category::MMGACTION_TRANSITION:                                                  \
    ...
    case MMGAction::Transitions::TRANSITION_CURRENT:                                               \
      ...
      lcd_double1.set_step(25.0, 250.0);                                                           \
      lcd_double1.set_default_value(obs_frontend_get_transition_duration());                       \
      break;                                                                                       \
  ...
  case MMGAction::Category::MMGACTION_FILTER:                                                      \
    ...
    MMGAction::do_obs_filter_enum(ui->editor_str2, MMGAction::Category::MMGACTION_SOURCE_VIDEO,    \
				  value);                                                          \
    break;                                                                                         \
  case MMGAction::Category::MMGACTION_MIDI:                                                        \
    set_strs_visible(true, true);                                                                  \
    ...
    for (int i = 0; i < ui->editor_type->count(); ++i) {                                           \
      if (ui->editor_type->itemText(i) == "Note On / Note Off")                                    \
	continue;                                                                                  \
  ...
  case MMGAction::Category::MMGACTION_INTERNAL:                                                    \
    if (current_action->get_sub() > 0) {                                                           \
      ...
      MMGAction::do_mmg_binding_enum(ui->editor_str2, current_binding->get_name(),                 \
...
#define INSERT_THIRD_OPTION()                                                                      \
  ...
  case MMGAction::Category::MMGACTION_SOURCE_VIDEO:                                                \
    ...
    case MMGAction::VideoSources::SOURCE_VIDEO_LOCKED:                                             \
      set_strs_visible(true, true, true);                                                          \
      ui->label_str3->setText("State");                                                            \
      ui->editor_str3->addItems({"Locked", "Unlocked", "Toggle"});                                 \
      break;                                                                                       \
    case MMGAction::VideoSources::SOURCE_VIDEO_CROP:                                               \
      ...
      lcd_double1.set_range(0.0, get_obs_source_dimensions(value).second >> 1);                    \
      lcd_double1.set_step(0.5, 5.0);                                                              \
      lcd_double1.set_default_value(0.0);                                                          \
      lcd_double2.set_range(0.0, get_obs_source_dimensions(value).first >> 1);                     \
      lcd_double2.set_step(0.5, 5.0);                                                              \
      lcd_double2.set_default_value(0.0);                                                          \
      lcd_double3.set_range(0.0, get_obs_source_dimensions(value).second >> 1);                    \
      lcd_double3.set_step(0.5, 5.0);                                                              \
      lcd_double3.set_default_value(0.0);                                                          \
      lcd_double4.set_range(0.0, get_obs_source_dimensions(value).first >> 1);                     \
    ...
    case MMGAction::VideoSources::SOURCE_VIDEO_ALIGNMENT:                                          \
      ...
      ui->editor_str3->addItems({"Top Left", "Top Center", "Top Right", "Middle Left",             \
	...
	{"Disable", "Point", "Bilinear", "Bicubic", "Lanczos", "Area", "Use Message Value"});      \
      break;                                                                                       \
    ...
    case MMGAction::VideoSources::SOURCE_VIDEO_BOUNDING_BOX_TYPE:                                  \
      ...
      ui->editor_str3->addItems({"No Bounds", "Stretch to Bounds", "Scale to Inner Bounds",        \
				 "Scale to Outer Bounds", "Scale to Width of Bounds",              \
    ...
    case MMGAction::VideoSources::SOURCE_VIDEO_BOUNDING_BOX_SIZE:                                  \
      ...
      lcd_double1.set_range(0.0, get_obs_source_dimensions(ui->editor_str1->currentText()).first); \
      lcd_double1.set_step(0.5, 5.0);                                                              \
      lcd_double1.set_default_value(0.0);                                                          \
      lcd_double2.set_range(0.0,                                                                   \
			    get_obs_source_dimensions(ui->editor_str1->currentText()).second);     \
      lcd_double2.set_step(0.5, 5.0);                                                              \
      lcd_double2.set_default_value(0.0);                                                          \
      break;                                                                                       \
    ...
    case MMGAction::VideoSources::SOURCE_VIDEO_BLEND_MODE:                                         \
      ...
      ui->editor_str3->addItems({"Normal", "Additive", "Subtract", "Screen", "Multiply",           \
				 "Lighten", "Darken", "Use Message Value"});                       \
      break;                                                                                       \
  ...
  case MMGAction::Category::MMGACTION_TRANSITION:                                                  \
    ...
    case MMGAction::Transitions::TRANSITION_SOURCE_HIDE:                                           \
      ...
      MMGAction::do_obs_source_enum(ui->editor_str3, MMGAction::Category::MMGACTION_SCENE, value); \
      break;                                                                                       \
    default:                                                                                       \
      break;                                                                                       \
    }                                                                                              \
  ...
  case MMGAction::Category::MMGACTION_FILTER:                                                      \
    ...
    case MMGAction::Filters::FILTER_REORDER:                                                       \
      set_doubles_visible(true);                                                                   \
      ui->label_double1->setText("Position");                                                      \
      lcd_double1.set_range(1.0, get_obs_source_filter_count(ui->editor_str1->currentText()));     \
  ...
  case MMGAction::Category::MMGACTION_INTERNAL:                                                    \
    if (current_action->get_sub() == 2) {                                                          \
      ...
      MMGAction::do_mmg_binding_enum(ui->editor_str3, current_binding->get_name(),                 \
...
#define PREFERENCE_FUNCTION_DECL(style)                                                           \
  ...
  {                                                                                               \
    QString filepath = QFileDialog::getSaveFileName(                                              \
      this, tr("Save Bindings..."), MMGConfig::get_filepath(), "JSON Files (*.json)");            \
    if (!filepath.isNull())                                                                       \
  ...
  {                                                                                               \
    QDesktopServices::openUrl(                                                                    \
      QUrl("https://github.com/nhielost/obs-midi-mg/blob/master/HELP.md"));                       \
  }                                                                                               \
                                                                                                  \
