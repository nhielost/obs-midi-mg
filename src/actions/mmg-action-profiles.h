...
class MMGActionProfiles : public MMGAction {
  ...
  Category get_category() const override { return Category::MMGACTION_PROFILE; }

  MMGUtils::MMGString &str1() override { return profile; };
  const MMGUtils::MMGString &str1() const override { return profile; };
